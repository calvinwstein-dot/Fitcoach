// FIXED SERVER CODE - Copy this to your Replit index.js
...
// ENHANCED CORS for audio streaming - THIS IS THE FIX!
app.use(cors({
  origin: '*',
...
app.get('/tts', async (req, res) => {
  ...
  const request = https.request(options, (response) => {
    if (response.statusCode === 200) {
      // ENHANCED HEADERS FOR WEB AUDIO COMPATIBILITY - THIS IS THE KEY FIX!
      res.set({
...
app.listen(PORT, () => {
  ...
  console.log(`✅ Enhanced CORS headers for web audio compatibility`);
});